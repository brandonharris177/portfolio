    ...
    <MainContent>
      <Section1>
        ...
        <CoreSkills>
          ...
          <p>I have experience working in a variety of fields before Web Development including Warehouse Manager, Turf and Solar Installation as well as a Contract Handyman. I love seeing the results of a well built project or piece of code come together. In many ways the principles are the same for construction and coding: have patience, don't be afraid to learn, and find satisfaction in the journey and the product. <br/>
